      ...
      {open && (
        ...
        >
          ...
          >
            ...
            <span style={{ fontFamily: 'var(--font-inter)', fontSize: 13, color: '#1D1D1D' }}>WhatsApp</span>
          </button>
          ...
          >
            ...
            <span style={{ fontFamily: 'var(--font-inter)', fontSize: 13, color: '#1D1D1D' }}>X / Twitter</span>
          </button>
          ...
          >
            ...
            <span style={{ fontFamily: 'var(--font-inter)', fontSize: 13, color: '#1D1D1D' }}>Facebook</span>
          </button>
          ...
          >
            ...
            <span style={{ fontFamily: 'var(--font-inter)', fontSize: 13, color: copied ? '#4CAF50' : '#1D1D1D' }}>

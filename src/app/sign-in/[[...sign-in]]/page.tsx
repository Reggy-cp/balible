          ...
          {showForgot ? (
            <>
              <button
                ...
                style={{ background: 'none', border: 'none', cursor: 'pointer', fontSize: 13, color: '#6F675C', padding: 0, marginBottom: 20, display: 'flex', alignItems: 'center', gap: 6 }}
              >
                ← Back to sign in
              </button>
              ...
              {resetSent ? (
                <div style={{ textAlign: 'center', padding: '32px 0' }}>
                  <div style={{ width: 52, height: 52, borderRadius: '50%', backgroundColor: '#F0F7F2', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 16px', fontSize: 22 }}>✉️</div>
                  <h2 style={{ fontFamily: 'var(--font-playfair)', fontSize: 22, fontWeight: 700, color: '#111111', margin: '0 0 8px' }}>Check your inbox</h2>
                  <p style={{ fontSize: 14, color: '#6F675C', lineHeight: 1.7, margin: 0 }}>
                    If an account exists for <strong>{resetEmail}</strong>, you'll receive a reset link shortly. Check your spam folder if you don't see it.
                  </p>
                </div>
              ) : (
                <>
                  <h1 style={{ fontFamily: 'var(--font-playfair)', fontSize: 28, fontWeight: 700, color: '#111111', margin: '0 0 6px' }}>Forgot your password?</h1>
                  <p style={{ fontSize: 14, color: '#6F675C', margin: '0 0 28px' }}>Enter your email and we'll send you a reset link.</p>
                  <form onSubmit={handleForgot}>
                    ...
                    <button
                      ...
                      style={{ height: 46, borderRadius: 10, backgroundColor: '#111111', color: 'white', fontSize: 14, fontWeight: 600, border: 'none', cursor: resetLoading ? 'not-allowed' : 'pointer', fontFamily: 'var(--font-inter)', opacity: resetLoading ? 0.7 : 1 }}
                    >
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div style={{ textAlign: 'right', marginBottom: 20 }}>
                  <button
                    ...
                    style={{ background: 'none', border: 'none', cursor: 'pointer', fontSize: 13, color: '#6F675C', padding: 0, textDecoration: 'underline' }}
                  >
                    Forgot password?
                  </button>
                </div>

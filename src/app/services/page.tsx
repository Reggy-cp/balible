    ...
    >
      ...
      <div className="p-4">
        ...
        <div className="flex items-center justify-between mt-2">
          <p style={{ fontSize: 13, color: '#1D1D1D' }}>
        ...
        <div className="flex items-center gap-2 mt-3 pt-3" style={{ borderTop: '1px solid #F3EEE5' }}>
          {s.providerAvatar && (
...
export default async function ServicesPage({
  ...
  return (
    <div style={{ fontFamily: 'var(--font-inter)', backgroundColor: '#F3EEE5', minHeight: '100vh' }}>
      ...
      {/* Category Filter */}
      <div className="sticky top-0 z-20 bg-[#F3EEE5]" style={{ borderBottom: '1px solid #E8E4DE' }}>
            ...
            {CATEGORIES.map(c => (
              <a
                ...
                style={{
                  ...
                  backgroundColor: category === c.key ? '#1D1D1D' : 'white',
                  color: category === c.key ? 'white' : '#6F675C',
                  border: `1px solid ${category === c.key ? '#1D1D1D' : '#E8E4DE'}`,
                }}
              >
                <span>{c.emoji}</span>
                <span>{c.label}</span>

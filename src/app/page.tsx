...
const STATIC_EXPERIENCES: ExperienceCard[] = [
  ...
  { slug: 'sound-healing-journey',     title: 'Sound Healing Journey',        area: 'Ubud',     rating: 4.8, reviews: 178, price: 350000, durationMins: 90,  duration: '90 minutes',maxGuests: 10, category: 'Wellness',           categorySlug: 'wellness',        photo: 'https://images.unsplash.com/photo-1506126613408-eca07ce68773?w=480&auto=format&fit=crop&q=80', featured: true,  badge: 'Bestseller', subcategory: null, level: 'All levels' },
  { slug: 'water-temple-purification', title: 'Water Temple Purification',    area: 'Gianyar',  rating: 4.8, reviews: 78,  price: 600000, durationMins: 240, duration: '4 hours',   maxGuests: 8,  category: 'Culture',           categorySlug: 'culture',         photo: 'https://images.unsplash.com/photo-1555400038-63f5ba517a47?w=480&auto=format&fit=crop&q=80', featured: false, badge: null,         subcategory: null, level: 'All levels' },
]

...
export default async function OnboardingPage() {
  ...
  return (
    <div style={{
      ...
      <h1 style={{ fontFamily: 'var(--font-playfair)', fontSize: 28, fontWeight: 700, color: '#1D1D1D', margin: '0 0 12px', textAlign: 'center' }}>
        Welcome to Balible
      </h1>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 16, width: '100%', maxWidth: 520 }}>
        <Link href="/onboarding/traveler" style={{ textDecoration: 'none' }}>
          <div style={{
            ...
            <p style={{ fontFamily: 'var(--font-playfair)', fontSize: 18, fontWeight: 700, color: '#1D1D1D', margin: 0 }}>Traveler</p>
            <p style={{ fontSize: 13, color: '#6F675C', margin: 0, lineHeight: 1.6 }}>Discover and book curated experiences across Bali</p>
            <div style={{
              marginTop: 'auto', paddingTop: 16, backgroundColor: '#1D1D1D', color: 'white',
        ...
        <Link href="/onboarding/host" style={{ textDecoration: 'none' }}>
          <div style={{
            ...
            <span style={{ fontSize: 36 }}>🏡</span>
            <p style={{ fontFamily: 'var(--font-playfair)', fontSize: 18, fontWeight: 700, color: '#1D1D1D', margin: 0 }}>Host</p>
            <p style={{ fontSize: 13, color: '#6F675C', margin: 0, lineHeight: 1.6 }}>Share your expertise and welcome guests to your experience</p>
            <div style={{
              marginTop: 'auto', paddingTop: 16, backgroundColor: '#B58A4B', color: 'white',
              borderRadius: 10, padding: '10px 0', textAlign: 'center', fontSize: 13, fontWeight: 600,
            }}>
              Continue as Host
            </div>

...
const STATIC_EXPERIENCES: CategoryExp[] = [
  ...
  { slug: 'balinese-cooking-class',  title: 'Balinese Cooking Class',           area: 'Ubud',       price: 420000, rating: 4.9, reviews: 187, duration: '4 hours',    maxGuests: 8,  image: 'https://images.unsplash.com/photo-1547592180-85f173990554?w=600&auto=format&fit=crop&q=80',    badge: 'Bestseller', category: 'food-drink', subcategory: 'Cooking Class'     },
  { slug: 'coffee-plantation-tour',  title: 'Coffee Plantation & Tasting Tour', area: 'Kintamani',  price: 320000, rating: 4.8, reviews: 143, duration: '3 hours',    maxGuests: 12, image: 'https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=600&auto=format&fit=crop&q=80',   badge: null,         category: 'food-drink', subcategory: 'Coffee & Tea'      },
  { slug: 'ubud-market-food-tour',   title: 'Ubud Market Food Tour',            area: 'Ubud',       price: 280000, rating: 4.8, reviews: 97,  duration: '3 hours',    maxGuests: 8,  image: 'https://images.unsplash.com/photo-1555400038-63f5ba517a47?w=600&auto=format&fit=crop&q=80',    badge: null,         category: 'food-drink', subcategory: 'Market Tour'       },

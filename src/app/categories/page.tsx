...
const CATEGORIES = [
  ...
  },
  {
    ...
    description: 'Cook a full Balinese feast, tour Ubud\'s morning market, or taste single-origin coffee at the plantation.',
    image: 'https://images.unsplash.com/photo-1547592180-85f173990554?w=800&auto=format&fit=crop&q=80',
    count: 3,
    avgPrice: 340000,
    featured: ['Balinese Cooking Class', 'Coffee Plantation Tour', 'Market Food Tour'],
    accent: '#C8A97E',
    span: 'lg:col-span-2',
    imageHeight: 'h-48',
  },

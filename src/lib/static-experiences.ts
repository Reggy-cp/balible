...
const RAW: StaticEntry[] = [
  ...
  { slug: 'water-temple-purification',    title: 'Water Temple Purification',         area: 'Gianyar',   rating: 4.8, reviews: 78,  price: 600000,  durationMins: 240, category: 'Culture',            photo: 'https://images.unsplash.com/photo-1555400038-63f5ba517a47?w=300&auto=format&fit=crop&q=80' },
  { slug: 'uluwatu-kecak-sunset',         title: 'Uluwatu Sunset & Kecak Dance',      area: 'Uluwatu',   rating: 4.9, reviews: 312, price: 450000,  durationMins: 180, category: 'Culture',            photo: 'https://images.unsplash.com/photo-1537996194471-e657df975ab4?w=300&auto=format&fit=crop&q=80' },
  { slug: 'balinese-dance-workshop',      title: 'Balinese Dance Workshop',           area: 'Ubud',      rating: 4.7, reviews: 84,  price: 380000,  durationMins: 120, category: 'Culture',            photo: 'https://images.unsplash.com/photo-1545569341-9eb8b30979d9?w=300&auto=format&fit=crop&q=80' },
  { slug: 'bali-language-class',          title: 'Balinese Language & Culture Class', area: 'Ubud',      rating: 4.6, reviews: 32,  price: 280000,  durationMins: 120, category: 'Culture',            photo: 'https://images.unsplash.com/photo-1583417267826-aebc4d1542e1?w=300&auto=format&fit=crop&q=80' },
